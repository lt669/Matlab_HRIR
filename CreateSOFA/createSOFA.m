...
for h=1:1
    ...
    if h==1
        ...
        extension = '_Raw.wav';
        sofaOutputFile = 'EAD_HRIR/Audio/SOFAFiles/RAW/';
    elseif h==2
        sofaFileSource = 'EAD_HRIR/Audio/HRIR_FFEQ/48k_24bit/';
        extension = '_FFC.wav';
        sofaOutputFile = 'EAD_HRIR/Audio/SOFAFiles/HRIR_FFEQ/';
    elseif h==3    
        sofaFileSource = 'EAD_HRIR/Audio/HRIR_DFFEQ/48k_24bit/';
        extension = '_DFFC.wav';
        sofaOutputFile = 'EAD_HRIR/Audio/SOFAFiles/HRIR_DFFEQ/';
    end
    ...
    Obj.GLOBAL_ApplicationName = 'EAD Measurements';
    ...
    mkdir(sprintf('%s%s',sofaOutputFile,subjectNumber));
    outfilename = sprintf('%s%s/%s.sofa',sofaOutputFile, subjectNumber,subjectNumber);
